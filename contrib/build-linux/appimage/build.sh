...
APPDIR="$BUILDDIR/electrum-xrc.AppDir"
...
APPIMAGE="$DISTDIR/ElectrumRhodium-$VERSION-x86_64.AppImage"
...
cp "$PROJECT_ROOT/electrum/gui/icons/electrum-xrc.png" "$APPDIR/electrum-xrc.png"
