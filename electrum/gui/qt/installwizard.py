...
WIF_HELP_TEXT = (_('WIF keys are typed in Electrum Rhodium, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of Electrum Rhodium will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.setWindowTitle('Electrum Rhodium  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-xrc.png')
        self.show()
        self.raise_()
    ...
    def run_upgrades(self, storage):
        ...
        if storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since Electrum Rhodium 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("Electrum Rhodium communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Electrum Rhodium "
